...
sub fixup_working_day_line
{
        ...
        $line =~ s/ OMIT SAT SUN AFTER ADDOMIT SCANFROM -28 / OMIT SAT SUN AFTER ADDOMIT SCANFROM -28 SATISFY [wkdaynum(date(\$Ty, $monnum, $day))==0 || wkdaynum(date(\$Ty, $monnum, $day))==6] /;
        $line =~ s/ OMIT SAT SUN BEFORE ADDOMIT SCANFROM -28 / OMIT SAT SUN BEFORE ADDOMIT SCANFROM -28 SATISFY [wkdaynum(date(\$Ty, $monnum, $day))==0 || wkdaynum(date(\$Ty, $monnum, $day))==6] /;
        return $line;
}
